...
(
    ...
    UNIQUE INDEX `phone_numpber_UNIQUE`
(
    `phone_number` ASC
) VISIBLE);
...
(
    ...
    INDEX `fk_photo_post1_idx`
(
    `post_id` ASC
) VISIBLE,
    INDEX `fk_photo_story1_idx`
(
    `story_id` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_video_post1_idx`
(
    `post_id` ASC
) VISIBLE,
    INDEX `fk_video_story1_idx`
(
    `story_id` ASC
) VISIBLE,
...
(
    ...
    INDEX `fk_like_comment_comment1_idx`
(
    `comment_id` ASC
) VISIBLE,
...
INSERT INTO user (followers, followings, description, email, phone_number, mention)
VALUES (1134, 3459, 'im nastya', 'anastasia.kajinska@gmail.com', '+38082344925', 'hello @anastainska'),
...
SELECT *
FROM kainska.security;
INSERT INTO security (nickname, password, user_id)
VALUES ('anastainska', '123baby', 1),
       ('oleg', 'olegparol', 2),
...
SELECT *
FROM kainska.story;
INSERT INTO story (reactions, user_iduser)
VALUES ('wow', 1),
       ('nice', 2),
       ('cool', 3),
       ('you look good', 4),
...
SELECT *
FROM kainska.post;
INSERT INTO post (user_id, text, photo, date_post)
VALUES (1, 'thats me', 'sdlfkvnsl', '2010-10-01 13:10:00.000'),
...
SELECT *
FROM kainska.photo;
INSERT INTO photo (photo, post_id, story_id)
VALUES ('sldnsl', 1, 1),
       ('wekfbjwl', 2, 2),
       ('sldnssldns', 3, 3),
       ('alknsfvl', 4, 4),
...
SELECT *
FROM kainska.message;
INSERT INTO message (text_message, time_creation, time_seen, user_id)
VALUES ('hello', '2019-11-10 13:00:00.000', '2019-11-11 14:00:00.000', 1),
...
SELECT *
FROM kainska.video;
INSERT INTO video (video, post_id, story_id)
VALUES ('skdjs', 1, 1),
       ('sglnls', 2, 2),
       ('weurewrio', 3, 3),
       ('sn xcv n', 4, 4),
...
SELECT *
FROM kainska.comment;
INSERT INTO comment (text, post_id, date_comment)
VALUES ('look nice', 1, '2019-12-10 13:03:10.000'),
       ('thats good', 2, '2019-12-10 13:53:00.000'),
       ('yaaas queen', 3, '2019-12-10 17:03:00.000'),
       ('lol', 4, '2019-12-10 10:03:00.000'),
       ('hey you look good', 5, '2019-12-10 12:03:00.000'),
       ('wow queen', 6, '2019-12-10 19:03:00.000'),
       ('thats my girl', 7, '2018-12-10 13:03:00.000'),
       ('will you be my sugar baby', 8, '2009-12-10 13:03:00.000'),
       ('marry me', 9, '2019-10-10 13:03:00.000'),
       ('that looks awful', 10, '2019-08-10 13:03:00.000');

SELECT *
FROM kainska.like_comment;
INSERT INTO like_comment (comment_id)
VALUES (1),
       (2),
       (3),
       (4),
...
SELECT *
FROM kainska.like_post;
INSERT INTO like_post (post_id, time_creation_like)
VALUES (1, '2008-12-10 14:03:00.000'),
