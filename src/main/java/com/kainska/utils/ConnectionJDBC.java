...
public class ConnectionJDBC {
    public static final String url = "jdbc:mysql://localhost:3306/kainska";
    private static final String user = "root";
    private static final String password = "Iamcrowley666";
    ...
    public static ConnectionJDBC prepareJDBCSession(ConnectionJDBC conJdbc) {
